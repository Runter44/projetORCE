...
<html>
      ...
      function changeFormation() {
        ...
        $.ajax({
          ...
          success : function(data){
            ...
            if (data != "<p>Rien à afficher pour cette formation.</p><br>") {
  ...
  <body>
    <div id="top-nav">
			...
			<div id="menu"><ul id="menupart1"><li><a href="home.php" id="sel"><li><a href="?rejoindreFormation"><div class="text">Rejoindre une formation</div><div class="under"></div></a>
					</li>
				</ul>
			</div>
			...
			<ul class="menuderoulant">
				<a href="?accueil"><li>Tous les enseignements</li></a><a href="?parametres"><li>Paramètres du compte</li></a><a href="?resumeEnseignements"><li>Résumé des enseignements</li></a><a href="?deconnexion"><li id="deco">Déconnexion</li></a>
			</ul>
    </div>
    <div id="container" class="container">
      <div class="h1paramCompte">
        <h1>Rejoindre une formation existante</h1>
        <p>Vous pourrez toujours rejoindre une formation supplémentaire ou la quitter à partir du menu Paramètres du compte.</p>
      </div>
      <?php
      if (isset($_GET["erreur"])) {
        echo "<div class='erreurParam'>";
        if ($_GET["erreur"]==1) {
          echo "Vous ne pouvez pas rejoindre une nouvelle formation car une formation vous est déjà assignée.";
        }
        echo "</div>";
      }
       ?>
      <form class="rejFormation" action="?joinFormation" method="post">
        <select id="selectFormation" name="formation" onchange="changeFormation();">
          <option disabled selected>Sélectionnez la formation à rejoindre...</option>
          <?php
        ...
        <button id="boutonRejoindreFormation" type="submit" name="Envoyer">Rejoindre la formation sélectionnée</button>
      </form>
    </div>
  </body>
</html>

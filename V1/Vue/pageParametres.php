      ...
      <div id="container" class="container">
        ...
        <?php
         ...
         <form class="modifParam" id="ajoutAutreFormation" action="?joinFormation" method="post">
           <table class="placementFormParam">
             <tr>
               <td id="tabHead" colspan="2"><h3>Rejoindre une formation supplémentaire</h3></td>
             </tr>
             <tr>
               <td id="tabGauche"><label for="formation">Formation supplémentaire à rejoindre</label></td>
               <td id="tabDroite">
             ...
             <tr>
               <td colspan="2" id="tabFoot"><button type="submit" name="validerMdp">Rejoindre la formation sélectionnée</button></td>
             </tr>
           </table>
         </form>
        <form class="modifParam" id="supprFormation" action="?retirerFormation" method="post">
          <table class="placementFormParam">
            <tr>
              <td id="tabHead" colspan="2"><h3>Se retirer d'une formation</h3></td>
            </tr>
            <tr>
              <td id="tabGauche"><label for="selectFormationRetirer">Formation à retirer</label></td>
              <td id="tabDroite">

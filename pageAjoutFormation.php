<!-- Script pour créer une nouvelle formation -->
...
<body>
  <div id="container">
    <div class="mdl-card__title">
      <h2 class="mdl-card__title-text" id="titrebleu">Ajout du département</h2>
    </div>
    <form action="index.php?ajoutFormationSub" method="POST">
      <?php if (isset($_GET["erreur"])) {
        switch ($_GET["erreur"]) {
          case '1':
            echo "<div class=\"erreur\">Veuillez entre un nom pour le département</div>";
            break;

          case '2':
            echo "<div class=\"erreur\">Si vous n'êtes pas administrateur du département, veuillez entre l'adresse mail d'un administrateur</div>";
            break;
          case '3':
        ...
        <input type="text" name="nom_formation" value="<?php echo htmlspecialchars($_GET["ajoutFormation"]);?>"  placeholder="Nom du département">
      ...
      <p>Attention ! Assurez-vous d'avoir l'accord du chef du département avant d'ajouter le département.</p>
